    ...
    return(
        <section className='experience-section' id={uid}>
            ...
            <div className='experiences'>
                <ExperienceItem brandName='INNLab' startDate='Feb 2025' finishDate='Present' jobTitle='UI designer & FrontEnd Developer' jobDescription='Design and development intuitive interfaces for an innovation measurement tool and a recommendation system powered by AI using Figma.'/>
                <ExperienceItem brandName='Immersive' startDate='Sep 2022' finishDate='Present' jobTitle='Community manager' jobDescription='Manage social media for multiple clients, including hotels in various cities across Colombia.'/>
